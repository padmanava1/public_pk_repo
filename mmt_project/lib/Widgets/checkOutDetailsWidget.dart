...
import 'package:mmt_project/Pages/selectCheckOutdateInCalender.dart';
...
class CheckOutDetailsWidget extends StatelessWidget {
  final calender = CleanCalendarController(
   ...
   CheckOutDetailsWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){
        Navigator.of(context).push(MaterialPageRoute(builder: (context) => SelectCheckOutDateInCalender()));
      },
      child: Padding(
