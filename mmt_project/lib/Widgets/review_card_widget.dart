...
class ReviewCardWidget extends StatelessWidget {
  ...
  const ReviewCardWidget({Key? key, required this.name, required this.description, required this.date, required this.ratingValue}) : super(key: key);
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    14.horizontalSpace,
                    Text('${name}',style: AppTextStyles.infoContentStyle,),
                    70.horizontalSpace,
                    RatingBar.builder(
                      ignoreGestures: true,
                      itemSize: 16,
              ...
              Row(mainAxisAlignment: MainAxisAlignment.end,
                children: [
                  Padding(
                    ...
                    child: Text('${date}',style: AppTextStyles.labelDetails,),
                  ),
                ],
              ),
            ],
